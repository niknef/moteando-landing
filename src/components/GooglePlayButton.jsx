export default function GooglePlayButton({ href = "#" }) {
    return (
      <a
        href={href}
        className="flex mt-3 w-48 h-14 bg-black text-white rounded-lg items-center justify-center
      hover:scale-105 hover:brightness-110 transition-all duration-200 ease-in-out
      hover:shadow-[0_2px_14px_0_rgba(232,110,27,0.2)]"
